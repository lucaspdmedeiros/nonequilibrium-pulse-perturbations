...
The repository contains 3 folders: *code*, *figs*, and *tables*. Under *code/scripts*, we provide commented R scripts to reproduce Figures 1-5 and SI figures. All figures from our study can be found under *figs*.
